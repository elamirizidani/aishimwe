...
echo "<span id='chat-logo'><strong>"."Online"."</strong></span></br><hr>";
  ...
  while($row = mysqli_fetch_array($run)){
    ...
    if($row["Profile_Picture"]==""){
        echo "<a href='Message/Message.php' class='users' id='$userID' name='$newusername' alt='$userslast_name'><li class='users' id='$userID' name='$newusername' alt='$userslast_name'>

        <img class='my_profile_image' src='Profile_Pictures/default.png' height='35' width='35'/>&nbsp;&nbsp;"."<strong>".$newusername."</strong><span class='users_status_not_active'></span></li></a>";
    }else{
        ...
        <span class='users_status_not_active'></span></li></a>";
    }
  }
    echo "</ul>";
    echo "</div>";
